    ...
    return(
        <section className="container-fluid p-5">
            <div className="row d-flex justify-content-center align-items-center">
                ...
                <h1 className="col-md-6"><img className="about-img img-fluid" src="https://static.vecteezy.com/system/resources/previews/011/153/364/original/3d-website-developer-working-on-laptop-illustration-png.png" alt="3d image of a cartoon man coding" /></h1>
            </div>
        </section>
    )
}